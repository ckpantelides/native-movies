      ...
      axios
        ...
        .then(response => {
          if (typeof response.data.listings == "undefined") {
            ...
            localStorage.setItem("cinemaID6", this.IDtoSearch);
            this.loading = false;
            this.error = false;
