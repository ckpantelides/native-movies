    ...
    getMovies(url) {
      axios
        ...
        .then(response => {
          ...
          localStorage.setItem("cinemaID1", this.IDtoSearch);
          this.loading = false;
          this.error = false;
