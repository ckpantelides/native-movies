      ...
      axios
        ...
        .then(response => {
          if (typeof response.data.listings == "undefined") {
            ...
            localStorage.setItem("cinemaID5", this.IDtoSearch);
            this.loading = false;
            this.error = false;
